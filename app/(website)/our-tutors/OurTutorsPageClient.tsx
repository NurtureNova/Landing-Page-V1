...
import { getActiveTutors, calculateNurtureNovaExperience, TutorDetail } from "@/data/tutors";
...
export default function OurTutorsPageClient() {
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {tutor.specialties.slice(0, 2).map((specialty: string, idx: number) => (
                      <span
                        key={idx}
